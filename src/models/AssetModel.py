...
class AssetModel(BaseDataModel):
    def __init__(self, db_client: object):
        ...
        self.collection=self.db_client[DataBaseEnum.COLLECTION_ASSET_NAME.value] #TAKE COLLECTION
    ...
    async def init_collection(self):
        ...
        if DataBaseEnum.COLLECTION_ASSET_NAME.value not in all_collections:
            ...
            self.collection= self.collection=self.db_client[DataBaseEnum.COLLECTION_ASSET_NAME.value]
