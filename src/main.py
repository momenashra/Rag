...
async def startup_span():
    ...
    VectorDBProvidersFactory = VectorDBProvidersFactory(settings)
    #generation client
    ...
    #vector db client
    app.vector_db_client = VectorDBProvidersFactory.create(provider_name=settings.VECTOR_DB_BACKEND)
