...
Revision ID: 10878da39ca0
Revises: 
Create Date: 2025-04-21 21:38:39.992546
...
def upgrade() -> None:
    ...
    op.create_index('idx_asset_uuid', 'assets', ['asset_uuid'], unique=False)
    ...
    op.create_index('idx_chunk_uuid', 'chunks', ['chunk_uuid'], unique=False)
